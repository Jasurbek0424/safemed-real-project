...
// import { safetyEqiupments } from '../../data/Json';
import ScrollToTop from './../ScrollToTop/ScrollToTop';
import Navigation from './../templates/Navigation';


const Safety = ({ safetyEqiupments, type }) => {
    ...
    const currentPageProducts = safetyEqiupments.slice(offset, offset + productsPerPage);
            ...
            <div>
                ...
                <main className='mt-10'>
                    <div className='container'>
                        <div className='my-6'>
                            <Navigation path={location.pathname} products={safetyEqiupments} />
                        </div>
                        <div className='w-full flex gap-10 justify-between searchContent'>
                            ...
                            <div className=''>
                                    ...
                                    {currentPageProducts.map((el) => (
                                        ...
                                        >
                                            <div className='border flex items-center justify-center rounded-[50px] py-6 px-12 border-primary'>
                                                <img src={el.image} alt={el.title} className='w-[100px] h-[150px]' />
                                            </div>
                                ...
                                <div className='flex justify-center my-4'>
                                    <ReactPaginate
                                        pageCount={Math.ceil(safetyEqiupments.length / productsPerPage)}
